...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_users(
            ...
            let path = http::uri::PathAndQuery::from_static("/crm.UserService/GetUsers");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("crm.UserService", "GetUsers"));
...
pub mod user_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/crm.UserService/GetUsers" => {
                    #[allow(non_camel_case_types)]
                    struct GetUsersSvc<T: UserService>(pub Arc<T>);
                    impl<T: UserService> tonic::server::UnaryService<super::GetUsersRequest> for GetUsersSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut =
                                async move { <T as UserService>::get_users(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
